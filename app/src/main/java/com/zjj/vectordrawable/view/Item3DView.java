...
public class Item3DView extends LinearLayout implements View.OnClickListener{
    ...
    public Item3DView(Context context) {
        super(context);
        init(context);
    }

    public Item3DView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public Item3DView(Context context, AttributeSet attrs, int defStyleAttr) {
